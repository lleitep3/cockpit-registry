#!/usr/bin/env sh
# deploy-skills.sh — Deploys KB search skills to each active AI provider.
# Called by: cockpit pkg install kb-search (post_install hook)
set -e

PACKAGE_DIR="$(cd "$(dirname "$0")/.." && pwd)"

echo "Deploying KB search skills to active AI providers..."
echo ""
...
echo ""
echo "AI providers will now automatically search the KB before responding."
echo "Run 'cockpit kb list' to see your current knowledge base."
